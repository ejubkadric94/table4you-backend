...
alter table abh_restaurant add constraint fk_abh_restaurant_address_3 foreign key (address_address_id) references abh_user_address (address_id) on delete restrict on update restrict;
create index ix_abh_restaurant_address_3 on abh_restaurant (address_address_id);
alter table abh_restaurant add constraint fk_abh_restaurant_coordinates_4 foreign key (coordinates_restaurantId) references abh_coordinates (restaurantId) on delete restrict on update restrict;
create index ix_abh_restaurant_coordinates_4 on abh_restaurant (coordinates_restaurantId);
